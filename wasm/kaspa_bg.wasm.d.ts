...
export function address_validate(a: number, b: number, c: number, d: number): number;
...
export function sompiToUnitString(a: number, b: number, c: number): void;
export function sompiToKaspaString(a: number, b: number): void;
export function kaspaToUnit(a: number, b: number, c: number): number;
...
export function transactionrecord_hasAddress(a: number, b: number, c: number): void;
export function transactionrecord_isCoinbase(a: number): number;
