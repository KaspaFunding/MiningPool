...
* @returns {string}
*/
export function sompiToUnitString(sompi: bigint | number | HexString, decimals: number): string;
/**
*
...
* @returns {bigint | undefined}
*/
export function kaspaToUnit(kaspa: string, decimals: number): bigint | undefined;
/**
...
* @returns {boolean}
*/
  static validate(address: string, network?: string): boolean;
/**
...
* @returns {boolean}
*/
  hasAddress(address: Address | string): boolean;
/**
